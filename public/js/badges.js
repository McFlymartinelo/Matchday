export function computeBadges(stats) {
  const badges = [];
  const { exactCount, diffCount, winnerCount, missCount, rank, memberCount, precision, xiPoints, scoredCount } = stats;
  ...
  if (exactCount === 0 && scoredCount >= 5) badges.push({ id: 'dry_spell', label: 'Sèche', emoji: '🌵' });
